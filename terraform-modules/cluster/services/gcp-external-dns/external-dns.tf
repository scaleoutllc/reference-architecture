...
module "iam-external-dns-for-gke" {
  ...
  role_description              = "External DNS role for GKE cluster ${var.cluster_name}"
...
resource "aws_iam_policy" "external-dns" {
  name        = "gke-external-dns-${var.cluster_name}"
  description = "External DNS policy for GKE cluster ${var.cluster_name}"
