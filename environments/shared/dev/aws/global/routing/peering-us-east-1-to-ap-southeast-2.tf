module "peering-us-east-1-to-ap-southeast-2" {
  ...
  accepter = {
    name               = data.tfe_outputs.fast-us-east-1-workload-cluster-network.values.vpc.name
    cidr               = data.tfe_outputs.fast-us-east-1-workload-cluster-network.values.vpc.cidr
  ...
  peer = {
    name               = data.tfe_outputs.fast-ap-southeast-2-workload-cluster-network.values.vpc.name
    cidr               = data.tfe_outputs.fast-ap-southeast-2-workload-cluster-network.values.vpc.cidr
