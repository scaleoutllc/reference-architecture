...
data "tfe_outputs" "fast-dev-gcp-us-east1-workload-cluster-network" {
  organization = "scaleout"
  workspace    = "fast-dev-gcp-us-east1-workload-cluster-network"
}

data "tfe_outputs" "fast-dev-gcp-australia-southeast1-workload-cluster-network" {
  organization = "scaleout"
  workspace    = "fast-dev-gcp-australia-southeast1-workload-cluster-network"
}

data "tfe_outputs" "fast-dev-aws-us-east-1-workload-cluster-network" {
  organization = "scaleout"
  workspace    = "fast-dev-aws-us-east-1-workload-cluster-network"
}

data "tfe_outputs" "fast-dev-aws-ap-southeast-2-workload-cluster-network" {
  organization = "scaleout"
...
locals {
  ...
  fast = {
    gcp-us-east1             = data.tfe_outputs.fast-dev-gcp-us-east1-workload-cluster-network.values
    gcp-australia-southeast1 = data.tfe_outputs.fast-dev-gcp-australia-southeast1-workload-cluster-network.values
    aws-us-east-1            = data.tfe_outputs.fast-dev-aws-us-east-1-workload-cluster-network.values
    aws-ap-southeast-2       = data.tfe_outputs.fast-dev-aws-ap-southeast-2-workload-cluster-network.values
  }
}
