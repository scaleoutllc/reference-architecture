resource "google_iam_workload_identity_pool" "tfc" {
  ...
  workload_identity_pool_id = "tfc-${google_project.main.name}"
...
resource "google_iam_workload_identity_pool_provider" "tfc" {
  ...
  workload_identity_pool_provider_id = "tfc-${google_project.main.name}"
  attribute_mapping = {
...
resource "google_service_account" "tfc" {
  project      = google_project.main.name
  account_id   = "tfc-${google_project.main.name}"
